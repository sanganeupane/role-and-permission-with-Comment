        ...
        <section class="content-header">
            ...
            <div class="row">
                <div class="col-md-9 offset-md-1 border p-4 shadow bg-light">
                    <div class="col-12">
                        <h3 class="fw-normal text-secondary fs-4 text-uppercase mb-4">Edit Invoice</h3>
                        <hr>
                    </div>

                    <form action="{{route('editInvoiceAction')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-6">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="number" name="contact" class="form-control"
                                       placeholder="Enter contact number " id="contact" value="{{$invoiceData->contact}}">
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <input type="text" name="address" class="form-control" placeholder=" Enter  address "
                                       id="address" value="{{$invoiceData->address}}">
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <input type="number" name="zip_code" class="form-control" placeholder="Enter zip code "
                                       id="zip_code" value="{{$invoiceData->zip_code}}">
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <input type="text" name="location" class="form-control" placeholder="Enter location"
                                       id="location" value="{{$invoiceData->location}}">
                            </div>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea type="text" name="descriptions" class="form-control"
                                          ...
                                          value="{!!$invoiceData->descriptions!!}"></textarea>
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <input type="text" name="service" class="form-control" placeholder="Enter service"
                                       id="service" value="{{$invoiceData->service}}">
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <input type="number" name="quantity" class="form-control" placeholder="Enter quantity"
                                       id="quantity" value="{{$invoiceData->quantity}}">
                            </div>
